...
try:
    ...
    print(f"✅ YOLOv8n model loaded successfully on {device}.")
...
def run_object_detection_model(image_data_b64):
    if model is None:
        return {"error": "Model not loaded. Cannot perform detection."}
...
def detect_objects():
    ...
    result = run_object_detection_model(image_data_b64)
